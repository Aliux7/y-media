    ...
    <div className="relative min-h-screen p-5 py-17.5 text-white">
      ...
      <div className="relative w-full flex items-stretch justify-start">
        <div className="relative z-10 w-1/2">
          ...
          <AnimatedText variant="reveal" className="uppercase text-6xl">
            WHAT
          </AnimatedText>
          <div className="flex justify-center items-center gap-12.5 pl-52">
            ...
            <AnimatedText
              ...
              variant={"reveal"}
              animateBorder
              className="w-84 py-3.5 text-center text-6xl"
            >
              LOVE
            </AnimatedText>
          </div>
          <div className="max-w-175 flex flex-col justify-start items-start mt-10 gap-7">
            <AnimateIn className="text-2xl text-balance">
            ...
            <AnimateIn className="text-lg indent-28">
            ...
            <div className="flex flex-col items-start gap-1 text-lg">
              <AnimateIn className="font-medium text-2xl indent-7">
                Images circulate.
              </AnimateIn>
              <AnimateIn className="ml-24 text-2xl underline decoration-3 underline-offset-4">
                Stories pass.
              </AnimateIn>
              <AnimateIn className="ml-36 text-2xl">
            ...
            <AnimateIn className="text-2xl">
              Y Media moves visual culture beyond this condition — into physical
              presence.
            </AnimateIn>
            <AnimateIn className="text-lg indent-24">
      ...
      <div className="relative w-full grid grid-cols-4 items-stretch justify-start gap-5 mt-10">
        ...
        <div className="col-span-1 space-y-7">
          ...
          <AnimateIn className="text-lg indent-8">
        ...
        <AnimateIn className="col-span-1 text-2xl text-balance">
        ...
        <div className="col-span-2">
          <AnimateIn className="text-lg indent-32">
          ...
          <AnimateIn className="text-lg mt-12 indent-32">
          ...
          <AnimateIn className="text-lg mt-8 indent-32">
          ...
          <div className="mt-12">
            <AnimateIn className="text-2xl underline decoration-3 underline-offset-5">
              Not just seen.
            </AnimateIn>
            <AnimateIn className="text-2xl underline decoration-3 underline-offset-5">
              Made present
